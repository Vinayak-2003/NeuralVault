...
from Backend.app.models.setting_model import Setting
from Backend.app.schemas.setting_schema import SettingResponse, SettingCreate
...
async def get_config(db: Annotated[Session, Depends(get_db_session)]):
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Error fetching configuration: {e}"
        )
